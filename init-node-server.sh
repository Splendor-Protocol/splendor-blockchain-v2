...
plenitud-template-node key insert --base-path /data/node01 --chain ./customSpecRaw.json --scheme Ed25519 --suri "electric pass pioneer magnet reward upon gloom deal pigeon cluster snake width" --password $PASSWORD --key-type gran
